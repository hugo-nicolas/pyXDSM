...
% Copied from pyXDSM repo; modified color and font settings
% reference: https://github.com/mdobook/text/blob/master/figures/mdo/XDSM/diagram_styles.tex
...
\definecolor{primarybox}{HTML}{A0CBE8}  % blue
\definecolor{secondarybox}{HTML}{FF9D9A} % red
\definecolor{tertiarybox}{HTML}{8CD17D} % green
\definecolor{bg}{HTML}{ffffff}
\definecolor{textcolor}{HTML}{000000}
% \definecolor{lighttext}{HTML}{79706E}
\definecolor{lighttext}{RGB}{160, 160, 160}
\definecolor{verylighttext}{RGB}{224, 224, 224}

% TODO: dark gray and gray for Newton and optimizer

% --- modify font ---
%%% \tikzstyle{every node}=[font=\sffamily,align=center]
\tikzstyle{every node}=[font=\rmfamily,align=center]
...
% Colors
\newcommand{\explicitColor}{primarybox}
\newcommand{\implicitColor}{secondarybox}
\newcommand{\mdaColor}{verylighttext}
\newcommand{\optimizationColor}{lighttext} % also used by DOE

% Component types
\tikzstyle{Optimization} = [\procShape,draw,fill=\optimizationColor!\fillOpacity,inner sep=6pt,minimum height=1cm,text badly centered]   % white text!
\tikzstyle{MDA} = [\procShape,draw,fill=\mdaColor!\fillOpacity,inner sep=6pt,minimum height=1cm,text badly centered]
